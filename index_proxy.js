...
function proxyGenerator() {
    ...
    request("https://sslproxies.org/", function (error, response, html) {
        ...
        if (!error && response.statusCode == 200)
        {
             ...
             * we used Cheerio痴 selectors to find the data in the first column and the second column, respectively.
        ...
        /*
         * generate a random number between 1 and 100 that we値l use for referencing the index number of the arrays 
         * and retrieving a random IP address from the list. 
         * This way, we値l ensure that we use a different proxy for each request.
         */
         ...
         * To achieve this, we値l use ES6 template literals to interpolate the variables into a single string.
 ...
 * Then, we値l specify a proxy option and call the previously created proxyGenerator() function, which produces random proxies
 */
const options = {
